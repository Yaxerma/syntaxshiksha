    ...
    const topics = {
        setup: (
            <div>
                ...
                <p>To start writing PHP code, you need to set up your development environment. Here are the tools you need:</p>
                <ul>
                    <li>Visual Studio Code with the PHP extension.</li>
                    <li>XAMPP or WAMP server for running PHP code.</li>
                </ul>
                <p>Once your environment is set up, you can write your first PHP program:</p>
...
?>`}
                ...
                <p>This program outputs "Hello, World!" to the browser. The `echo` statement is used to display the output.</p>
            </div>
        ),
        syntax: (
            <div>
