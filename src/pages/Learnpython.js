  ...
  const topics = {
    setup: (
      <div>
        ...
        <p>To start writing Python code, you need to set up your development environment. Here are the tools you need:</p>
        <ul>
          <li>Visual Studio Code with the Python extension.</li>
          <li>Python interpreter installed on your machine.</li>
        </ul>
        <p>Once your environment is set up, you can write your first Python program:</p>
        <pre style={{ backgroundColor: '#f4f4f4', padding: '10px', borderRadius: '5px' }}>
          <code>
            {`print("Hello, World!")`}
          </code>
        </pre>
        <p>This program outputs "Hello, World!" to the console. The `print` function is used to display the output.</p>
      </div>
    ),
    syntax: (
      <div>
    ...
    collections: (
      <div>
        <h2>Collections (Lists, Dictionaries)</h2>
